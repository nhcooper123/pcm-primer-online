...
## Datasets and trees {-}
All datasets and trees for each exercise are available for download as a ZIP from [here](https://download-directory.github.io?url=https://github.com/nhcooper123/pcm-primer-online/tree/main/data). When you click this link it will take you to a website and the download should start automatically. 
...
The 522 species tree for this example comes from Letsch et al. 2016a @letsch2016not and is available to download from Letsch et al. 2016b @letsch2016data. This paper looked across dragonflies to investigate whether species from lotic habitats with fast flowing waters diversify more rapidly than species from lentic habitats with slow moving waters. If you want to see the full results check out Letsch et al. 2016a @letsch2016not! 
...
This document was created using the packages `bookdown` [@bookdown2025], [@bookdown2016], `knitr` [@knitr2014], [@knitr2015], [@knitr2025] and `rmarkdown` [@rmarkdown2018], [@rmarkdown2020], [@rmarkdown2025].
