...
## Before you start
- Open the `06_PGLS.RProj` file in the `06_PGLS` folder to open your R Project for this exercise.
...
```{block, type = "warning"}
**Always** make sure you check the list of dropped species is what you expected, it often reveals typos in your species names, or mismatches in taxonomies used etc. Here we already fixed this problem, so nothing is listed. See the `04-Preparation.Rmd` chapter for more details.
```
