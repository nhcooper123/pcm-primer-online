...
There are many more things you can do with `ggtree`, all based on this idea of adding layers. See the [manual for `ggtree`](http://yulab-smu.top/treedata-book/index.html) for more details.
...
Using the `frog-tree.nex` phylogeny, see if you can do the following. Note that we will talk more about this tree in later exercises, but it comes from @feng2017phylogenomics.
