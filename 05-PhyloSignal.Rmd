# Phylogenetic Signal in R {#signal}
...
4. `phytools` - to estimate $\lambda$ and K [@phytools]
5. `caper` - to estimate D [@caper]
...
`phylo.d` estimates the D value, then tests the estimated D value for significant departure from random association and a Brownian evolution threshold model (see [here](https://nhcooper123.github.io/pcm-primer/signal.html#calculating-d-for-binary-traits) and @fritz2010selectivity for more details).
