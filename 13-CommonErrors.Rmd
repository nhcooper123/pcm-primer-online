...
2. Tree is not rooted.
- Use `is.rooted` to check. 
- Fix using `root`.

3. Tree is not fully bifurcating, i.e. it has polytomies.
- Use `is.binary` to check. 
- Fix using `multi2di`.

4. Species names in the tree and the data do not match.
...
5. Species names have not been added to the data.
...
10. Unrealistic parameter estimates.
