...
If everything worked you will see some (often a lot if you're installing a big package like `tidyverse` or `ggtree`) text appearing in the console, and the occasional *warning* message but importantly __no error messages__. If you do see an error message, something, somewhere has gone wrong. Installation errors will generally say something about `non-zero exit status` of the package, which just tells you that it was not installed.
