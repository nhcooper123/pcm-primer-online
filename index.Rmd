...
![Snakes have different head shapes in different habitats. These are (clockwise starting in the top left) terrestrial/semiaquatic, aquatic, aquatic burrowing, and burrowing natricines. Image credits: @deepak2023](images/snakes.jpg)
...
The data for this example comes from @deepak2023, and the tree comes from @deepak2021. If you want to see the full results check out @deepak2023! And there's a nice summary of the paper [here]().
