...
As well as the standard regression outputs, the output includes the estimated ML value of $\lambda$ (0.976) and p values from likelihood ratio tests showing whether the ML $\lambda$ is significantly different from 0 or 1. 
...
If you've no idea what these diagnostic plots are for I suggest reading up on this. Getting Started with R is a good place for this (CITE).
...
2. In plot 2 (upper right-hand plot), the Normal Q-Q plot, the points should approximately fall on the line. This tests for normality of residuals, one of the assumptions of linear models.
